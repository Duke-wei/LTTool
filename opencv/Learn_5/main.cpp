...
//	cout<<"the srcImage channels is "<<srcImage.channels()<<endl;
//	split(srcImage,channels);
//	namedWindow("sample");
//	for(int i=0;i<(int)channels.size();++i){
//		imshow("sample",channels.at(i));
//		waitKey(0);
//	}
//}
//
...
{  
       ...
       addWeighted(imageGreenChannel(Rect(100,150,logoImage.cols,logoImage.rows)),1.0,  
              logoImage,0.5,0.,imageGreenChannel(Rect(100,150,logoImage.cols,logoImage.rows)));  
       ...
       addWeighted(imageRedChannel(Rect(100,150,logoImage.cols,logoImage.rows)),1.0,  
              logoImage,0.5,0.,imageRedChannel(Rect(100,150,logoImage.cols,logoImage.rows)));  
